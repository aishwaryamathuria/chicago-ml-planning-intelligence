...
type Report3DResult struct {
	ZipCode   string `json:"zip_code"`
	CaseCount string `json:"case_count"`
}

func HandleReport3D(w http.ResponseWriter, r *http.Request) {
	...
	var results []Report3DResult
	for rows.Next() {
		var r Report3DResult
